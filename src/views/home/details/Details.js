...
const styles = StyleSheet.create({
    ...
    descriptionText: {
        ...
        color: colors.MAIN_COLORS.DARK_GRAY,
        height: 85,
    },
    infoWrapper: {
        flexDirection: 'row',
    ...
    infoText: {
        fontFamily: 'Lato-Bold',
        fontSize: 24,
        color: colors.MAIN_COLORS.ORANGE,
    },
    infoSubText: {
        fontFamily: 'Lato-Bold',
        fontSize: 14,
    ...
    buttonWrapper: {
        marginHorizontal: 20,
        marginTop: 40,
        backgroundColor: colors.MAIN_COLORS.ORANGE,
        alignItems: 'center',
        justifyContent: 'center',
        paddingVertical: 15,
        borderRadius: 10,
        ...
        <View style={styles.container}>
            <ImageBackground source={item.imageBig} style={styles.backgroundImage}>
                <TouchableOpacity style={styles.backIcon} onPress={() => navigation.goBack()}>
                    <Entypo name="chevron-left" size={32} color={colors.MAIN_COLORS.WHITE} />
                </TouchableOpacity>
                <View style={styles.titlesWrapper}>
                    <Text style={styles.itemTitle}>{item.title}</Text>
                    <View style={styles.locationWrapper}>
                        <Entypo name="location-pin" size={24} color={colors.MAIN_COLORS.WHITE} />
            ...
            <View style={styles.descriptionWrapper}>
                <View style={styles.heartWrapper}>
                    <Entypo name="heart" size={32} color={colors.MAIN_COLORS.ORANGE} />
                </View>
